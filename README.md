...
# run the container
docker stop poker-bot-demo-server && docker rm poker-bot-demo-server && docker run -d -p 9001:9001 --restart unless-stopped --name poker-bot-demo-server -v ./data:/app/data poker-bot-demo-server
```
